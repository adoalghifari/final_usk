...
@if (Auth::user()->role == 'siswa')
    <div class="card shadow-sm border-0 p-4">
        <div class="card-body">
            ...
            <div class="col text-end">
                ...
                <button class="btn btn-info me-2" data-bs-toggle="modal" data-bs-target="#formTransfer">Transfer</button>
            ...
            <div class="modal fade" id="formTopUp" tabindex="-1" aria-labelledby="formTopUpLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="formwithdraw" tabindex="-1" aria-labelledby="formWithdrawLabel" aria-hidden="true">
        <div class="modal-dialog">
    ...
    <!-- Modal Transfer -->
    <div class="modal fade" id="formTransfer" tabindex="-1" aria-labelledby="formTransferLabel" aria-hidden="true">
        <div class="modal-dialog">
    ...
    <div class="container my-4">
        <div class="row mb-4">
            ...
            <div class="col-md-6 text-md-end">
                <button class="btn btn-success me-2" data-bs-toggle="modal" data-bs-target="#formTopUp">Top Up</button>
                <button class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#formWithdraw">Withdraw</button>              
            </div>
        </div>
                ...
                <div class="modal-dialog">                                       
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="number" name="credit" class="form-control" placeholder="Jumlah Top Up" min="1000" value="10000">
                        </div>
                        <div class="modal-footer">
                ...
                <div class="modal-dialog">                                  
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="number" name="debit" class="form-control" placeholder="Jumlah Withdraw" min="1000" value="10000">
                        </div>
                        <div class="modal-footer">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('bank.edit', $user) }}" class="btn btn-sm btn-outline-warning me-1" title="Edit">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <form action="{{ route('bank.destroy', $user->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('delete')
                                                <button class="btn btn-sm btn-outline-danger" onclick="return confirm('Hapus {{ $user->name }}?')" title="Delete">
                    ...
                    <table id="userTable" class="table table-sm table-bordered align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $user->email }}</td>
                                <td class="text-center">
                                    <a href="{{ route('user.edit', $user) }}" class="btn btn-sm btn-outline-warning me-1" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
